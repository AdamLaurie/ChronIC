...
#    define __mrfi_GET_PAYLOAD_LEN__(p)     ((p)->frame[__mrfi_LENGTH_FIELD_OFS__] - \
...
#    define __mrfi_LENGTH_FIELD_OFS__       0
#    define __mrfi_FCF_OFS__                (__mrfi_LENGTH_FIELD_OFS__ + \
...
#    define __mrfi_HEADER_SIZE__            ((2 * \
                                              __mrfi_ADDR_SIZE__) + __mrfi_FCF_SIZE__ + \
                                             __mrfi_DSN_SIZE__)
#    define __mrfi_FRAME_OVERHEAD_SIZE__    (__mrfi_LENGTH_FIELD_SIZE__ + __mrfi_HEADER_SIZE__)
