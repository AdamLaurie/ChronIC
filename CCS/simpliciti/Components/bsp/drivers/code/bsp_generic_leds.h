...
#    define __bsp_LED1_TURN_ON__()    __bsp_LED_TURN_ON__(__bsp_LED1_BIT__, __bsp_LED1_PORT__, \
                                                          __bsp_LED1_DDR__, \
                                                          __bsp_LED1_IS_ACTIVE_LOW__)
#    define __bsp_LED1_TURN_OFF__()   __bsp_LED_TURN_OFF__(__bsp_LED1_BIT__, __bsp_LED1_PORT__, \
                                                           __bsp_LED1_DDR__, \
                                                           __bsp_LED1_IS_ACTIVE_LOW__)
#    define __bsp_LED1_TOGGLE__()     __bsp_LED_TOGGLE__(__bsp_LED1_BIT__, __bsp_LED1_PORT__, \
                                                         __bsp_LED1_DDR__, \
                                                         __bsp_LED1_IS_ACTIVE_LOW__)
#    define __bsp_LED1_IS_ON__()      __bsp_LED_IS_ON__(__bsp_LED1_BIT__, __bsp_LED1_PORT__, \
                                                        __bsp_LED1_DDR__, \
                                                        __bsp_LED1_IS_ACTIVE_LOW__)
#    define __bsp_LED1_CONFIG__()     __bsp_LED_CONFIG__(__bsp_LED1_BIT__, __bsp_LED1_PORT__, \
                                                         __bsp_LED1_DDR__, \
                                                         __bsp_LED1_IS_ACTIVE_LOW__)
...
#    define __bsp_LED2_TURN_ON__()    __bsp_LED_TURN_ON__(__bsp_LED2_BIT__, __bsp_LED2_PORT__, \
                                                          __bsp_LED2_DDR__, \
                                                          __bsp_LED2_IS_ACTIVE_LOW__)
#    define __bsp_LED2_TURN_OFF__()   __bsp_LED_TURN_OFF__(__bsp_LED2_BIT__, __bsp_LED2_PORT__, \
                                                           __bsp_LED2_DDR__, \
                                                           __bsp_LED2_IS_ACTIVE_LOW__)
#    define __bsp_LED2_TOGGLE__()     __bsp_LED_TOGGLE__(__bsp_LED2_BIT__, __bsp_LED2_PORT__, \
                                                         __bsp_LED2_DDR__, \
                                                         __bsp_LED2_IS_ACTIVE_LOW__)
#    define __bsp_LED2_IS_ON__()      __bsp_LED_IS_ON__(__bsp_LED2_BIT__, __bsp_LED2_PORT__, \
                                                        __bsp_LED2_DDR__, \
                                                        __bsp_LED2_IS_ACTIVE_LOW__)
#    define __bsp_LED2_CONFIG__()     __bsp_LED_CONFIG__(__bsp_LED2_BIT__, __bsp_LED2_PORT__, \
                                                         __bsp_LED2_DDR__, \
                                                         __bsp_LED2_IS_ACTIVE_LOW__)
...
#    define __bsp_LED3_TURN_ON__()    __bsp_LED_TURN_ON__(__bsp_LED3_BIT__, __bsp_LED3_PORT__, \
                                                          __bsp_LED3_DDR__, \
                                                          __bsp_LED3_IS_ACTIVE_LOW__)
#    define __bsp_LED3_TURN_OFF__()   __bsp_LED_TURN_OFF__(__bsp_LED3_BIT__, __bsp_LED3_PORT__, \
                                                           __bsp_LED3_DDR__, \
                                                           __bsp_LED3_IS_ACTIVE_LOW__)
#    define __bsp_LED3_TOGGLE__()     __bsp_LED_TOGGLE__(__bsp_LED3_BIT__, __bsp_LED3_PORT__, \
                                                         __bsp_LED3_DDR__, \
                                                         __bsp_LED3_IS_ACTIVE_LOW__)
#    define __bsp_LED3_IS_ON__()      __bsp_LED_IS_ON__(__bsp_LED3_BIT__, __bsp_LED3_PORT__, \
                                                        __bsp_LED3_DDR__, \
                                                        __bsp_LED3_IS_ACTIVE_LOW__)
#    define __bsp_LED3_CONFIG__()     __bsp_LED_CONFIG__(__bsp_LED3_BIT__, __bsp_LED3_PORT__, \
                                                         __bsp_LED3_DDR__, \
                                                         __bsp_LED3_IS_ACTIVE_LOW__)
...
#    define __bsp_LED4_TURN_ON__()    __bsp_LED_TURN_ON__(__bsp_LED4_BIT__, __bsp_LED4_PORT__, \
                                                          __bsp_LED4_DDR__, \
                                                          __bsp_LED4_IS_ACTIVE_LOW__)
#    define __bsp_LED4_TURN_OFF__()   __bsp_LED_TURN_OFF__(__bsp_LED4_BIT__, __bsp_LED4_PORT__, \
                                                           __bsp_LED4_DDR__, \
                                                           __bsp_LED4_IS_ACTIVE_LOW__)
#    define __bsp_LED4_TOGGLE__()     __bsp_LED_TOGGLE__(__bsp_LED4_BIT__, __bsp_LED4_PORT__, \
                                                         __bsp_LED4_DDR__, \
                                                         __bsp_LED4_IS_ACTIVE_LOW__)
#    define __bsp_LED4_IS_ON__()      __bsp_LED_IS_ON__(__bsp_LED4_BIT__, __bsp_LED4_PORT__, \
                                                        __bsp_LED4_DDR__, \
                                                        __bsp_LED4_IS_ACTIVE_LOW__)
#    define __bsp_LED4_CONFIG__()     __bsp_LED_CONFIG__(__bsp_LED4_BIT__, __bsp_LED4_PORT__, \
                                                         __bsp_LED4_DDR__, \
                                                         __bsp_LED4_IS_ACTIVE_LOW__)
...
#    define __bsp_LED5_TURN_ON__()    __bsp_LED_TURN_ON__(__bsp_LED5_BIT__, __bsp_LED5_PORT__, \
                                                          __bsp_LED5_DDR__, \
                                                          __bsp_LED5_IS_ACTIVE_LOW__)
#    define __bsp_LED5_TURN_OFF__()   __bsp_LED_TURN_OFF__(__bsp_LED5_BIT__, __bsp_LED5_PORT__, \
                                                           __bsp_LED5_DDR__, \
                                                           __bsp_LED5_IS_ACTIVE_LOW__)
#    define __bsp_LED5_TOGGLE__()     __bsp_LED_TOGGLE__(__bsp_LED5_BIT__, __bsp_LED5_PORT__, \
                                                         __bsp_LED5_DDR__, \
                                                         __bsp_LED5_IS_ACTIVE_LOW__)
#    define __bsp_LED5_IS_ON__()      __bsp_LED_IS_ON__(__bsp_LED5_BIT__, __bsp_LED5_PORT__, \
                                                        __bsp_LED5_DDR__, \
                                                        __bsp_LED5_IS_ACTIVE_LOW__)
#    define __bsp_LED5_CONFIG__()     __bsp_LED_CONFIG__(__bsp_LED5_BIT__, __bsp_LED5_PORT__, \
                                                         __bsp_LED5_DDR__, \
                                                         __bsp_LED5_IS_ACTIVE_LOW__)
...
#    define __bsp_LED6_TURN_ON__()    __bsp_LED_TURN_ON__(__bsp_LED6_BIT__, __bsp_LED6_PORT__, \
                                                          __bsp_LED6_DDR__, \
                                                          __bsp_LED6_IS_ACTIVE_LOW__)
#    define __bsp_LED6_TURN_OFF__()   __bsp_LED_TURN_OFF__(__bsp_LED6_BIT__, __bsp_LED6_PORT__, \
                                                           __bsp_LED6_DDR__, \
                                                           __bsp_LED6_IS_ACTIVE_LOW__)
#    define __bsp_LED6_TOGGLE__()     __bsp_LED_TOGGLE__(__bsp_LED6_BIT__, __bsp_LED6_PORT__, \
                                                         __bsp_LED6_DDR__, \
                                                         __bsp_LED6_IS_ACTIVE_LOW__)
#    define __bsp_LED6_IS_ON__()      __bsp_LED_IS_ON__(__bsp_LED6_BIT__, __bsp_LED6_PORT__, \
                                                        __bsp_LED6_DDR__, \
                                                        __bsp_LED6_IS_ACTIVE_LOW__)
#    define __bsp_LED6_CONFIG__()     __bsp_LED_CONFIG__(__bsp_LED6_BIT__, __bsp_LED6_PORT__, \
                                                         __bsp_LED6_DDR__, \
                                                         __bsp_LED6_IS_ACTIVE_LOW__)
...
#    define __bsp_LED7_TURN_ON__()    __bsp_LED_TURN_ON__(__bsp_LED7_BIT__, __bsp_LED7_PORT__, \
                                                          __bsp_LED7_DDR__, \
                                                          __bsp_LED7_IS_ACTIVE_LOW__)
#    define __bsp_LED7_TURN_OFF__()   __bsp_LED_TURN_OFF__(__bsp_LED7_BIT__, __bsp_LED7_PORT__, \
                                                           __bsp_LED7_DDR__, \
                                                           __bsp_LED7_IS_ACTIVE_LOW__)
#    define __bsp_LED7_TOGGLE__()     __bsp_LED_TOGGLE__(__bsp_LED7_BIT__, __bsp_LED7_PORT__, \
                                                         __bsp_LED7_DDR__, \
                                                         __bsp_LED7_IS_ACTIVE_LOW__)
#    define __bsp_LED7_IS_ON__()      __bsp_LED_IS_ON__(__bsp_LED7_BIT__, __bsp_LED7_PORT__, \
                                                        __bsp_LED7_DDR__, \
                                                        __bsp_LED7_IS_ACTIVE_LOW__)
#    define __bsp_LED7_CONFIG__()     __bsp_LED_CONFIG__(__bsp_LED7_BIT__, __bsp_LED7_PORT__, \
                                                         __bsp_LED7_DDR__, \
                                                         __bsp_LED7_IS_ACTIVE_LOW__)
...
#    define __bsp_LED8_TURN_ON__()    __bsp_LED_TURN_ON__(__bsp_LED8_BIT__, __bsp_LED8_PORT__, \
                                                          __bsp_LED8_DDR__, \
                                                          __bsp_LED8_IS_ACTIVE_LOW__)
#    define __bsp_LED8_TURN_OFF__()   __bsp_LED_TURN_OFF__(__bsp_LED8_BIT__, __bsp_LED8_PORT__, \
                                                           __bsp_LED8_DDR__, \
                                                           __bsp_LED8_IS_ACTIVE_LOW__)
#    define __bsp_LED8_TOGGLE__()     __bsp_LED_TOGGLE__(__bsp_LED8_BIT__, __bsp_LED8_PORT__, \
                                                         __bsp_LED8_DDR__, \
                                                         __bsp_LED8_IS_ACTIVE_LOW__)
#    define __bsp_LED8_IS_ON__()      __bsp_LED_IS_ON__(__bsp_LED8_BIT__, __bsp_LED8_PORT__, \
                                                        __bsp_LED8_DDR__, \
                                                        __bsp_LED8_IS_ACTIVE_LOW__)
#    define __bsp_LED8_CONFIG__()     __bsp_LED_CONFIG__(__bsp_LED8_BIT__, __bsp_LED8_PORT__, \
                                                         __bsp_LED8_DDR__, \
                                                         __bsp_LED8_IS_ACTIVE_LOW__)
